...
interface StandardTokenMockInterface extends Interface {
  functions: {
...
export class StandardTokenMock extends Contract {
  connect(signerOrProvider: Signer | Provider | string): StandardTokenMock;
  attach(addressOrName: string): StandardTokenMock;
  deployed(): Promise<StandardTokenMock>;

  on(event: EventFilter | string, listener: Listener): StandardTokenMock;
  once(event: EventFilter | string, listener: Listener): StandardTokenMock;
  addListener(
    eventName: EventFilter | string,
    listener: Listener
  ): StandardTokenMock;
  removeAllListeners(eventName: EventFilter | string): StandardTokenMock;
  removeListener(eventName: any, listener: Listener): StandardTokenMock;
