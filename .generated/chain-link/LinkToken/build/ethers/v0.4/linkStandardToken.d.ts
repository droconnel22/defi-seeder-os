...
interface linkStandardTokenInterface extends Interface {
  functions: {
...
export class linkStandardToken extends Contract {
  connect(signerOrProvider: Signer | Provider | string): linkStandardToken;
  attach(addressOrName: string): linkStandardToken;
  deployed(): Promise<linkStandardToken>;

  on(event: EventFilter | string, listener: Listener): linkStandardToken;
  once(event: EventFilter | string, listener: Listener): linkStandardToken;
  addListener(
    eventName: EventFilter | string,
    listener: Listener
  ): linkStandardToken;
  removeAllListeners(eventName: EventFilter | string): linkStandardToken;
  removeListener(eventName: any, listener: Listener): linkStandardToken;
